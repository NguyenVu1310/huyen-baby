...
CountUp.prototype.calculate = function (id) {
    ...
    countainer.innerHTML = "<strong>" + this.years + "</strong> <small>year</small>" +
    " <strong>" + this.months + "</strong> <small>month</small>" +
    " <strong>" + this.days + "</strong> <small>day</small>" +
    " <strong>" + this.hours + "</strong> <small>hour</small>" +
    " <strong>" + this.minutes + "</strong> <small>minute</small>" +
